...
bool Triangle::checkCond() {
	...
	if (m_vertex1.m_row != m_vertex3.m_row)
		return true;
	if (getLength() != calculateLength(m_vertex1, m_vertex2) ||
		getLength() != calculateLength(m_vertex2, m_vertex3))
		return true;
...
Vertex Triangle::getCenter() const {
	...
	double centerX = m_vertex1.m_col + m_vertex2.m_col + m_vertex3.m_col;
	double centerY = m_vertex1.m_col + m_vertex2.m_col + m_vertex3.m_col;
